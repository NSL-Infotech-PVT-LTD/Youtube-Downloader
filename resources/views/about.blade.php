...
<section class="content-area about">
    ...
    <div class="about-banner">
        <div class="container">
            <h2>What We Do</h2>
            <p>Ut sodales, due scelerisque dapibus elementun, nunc tortor vulpulate diam,<br>eget interdum turpis sed dolor. Interger sem arcu, ultries.</p>
        </div>
    </div>
    <div class="container">
        <div class="row banner content">
